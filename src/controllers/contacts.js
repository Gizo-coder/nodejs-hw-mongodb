...
export const getAllContacts = async (req, res, next) => {
  try {
    ...
    res.json({ status: 200, message: 'Successfully retrieved contacts', data: contacts });
  } catch (err) { next(err); }
};
...
export const getContactById = async (req, res, next) => {
  try {
    ...
    res.json({ status: 200, message: 'Successfully retrieved a contact', data: contact });
  } catch (err) { next(err); }
};
...
export const updateContact = async (req, res, next) => {
  try {
    ...
    res.json({ status: 200, message: 'Successfully updated a contact!', data: updated });
  } catch (err) { next(err); }
};
